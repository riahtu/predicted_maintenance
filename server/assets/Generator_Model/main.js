...
loader.load(
  ...
  function(gltf) {
    ...
    ourObj = gltf.scene;
    ourObj.children[0].position.x = 0.9;
    ourObj.children[0].position.y = -0.1;
    ourObj.children[0].position.z = 0.5;

    ourObj.children[0].rotation.y = 0.70089;
    ourObj.children[0].rotation.z = -0.1;
